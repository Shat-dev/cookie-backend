...
class EntryRepository {
    ...
    async deleteEntriesByTweetId(tweetId) {
        ...
        if (pushedRounds.length > 0) {
            ...
            console.log(`⚠️ Removed ${pushedRounds.length} entries that were already pushed to rounds: ${uniqueRounds.join(", ")}`);
            console.log(`ℹ️ These entries will remain in the on-chain lottery for those rounds`);
        }
    }
