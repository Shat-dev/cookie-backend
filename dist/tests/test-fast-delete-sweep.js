...
async function runTests() {
    ...
    try {
        ...
        console.log(`  Valid numeric IDs: ${numericIds.length} [${numericIds.join(", ")}]`);
        console.log(`  Invalid IDs filtered: ${invalidIds.length} [${invalidIds.join(", ")}]`);
        ...
        const aliveTweets = new Set(["111", "333", "555"]);
...
//# sourceMappingURL=test-fast-delete-sweep.js.map