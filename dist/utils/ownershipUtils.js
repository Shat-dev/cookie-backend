...
exports.getGachaContract = getGachaContract;
...
if (!ethers_1.ethers.isAddress(GACHA_ADDRESS)) {
    throw new Error(`❌ GACHA_ADDRESS is not a valid address: ${GACHA_ADDRESS}`);
}
const ABI_PATH = path_1.default.join(__dirname, "../constants/GachaABI.json");
...
function getGachaContract() {
    return new ethers_1.ethers.Contract(GACHA_ADDRESS, GachaABI, provider);
}
